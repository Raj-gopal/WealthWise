...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Rajgopal Kumar" => "rajgk0000@gmail.com" }
  # Or just: spec.author    = "Rajgopal Kumar"
  # spec.authors            = { "Rajgopal Kumar" => "rajgk0000@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Rajgopal Kumar"
